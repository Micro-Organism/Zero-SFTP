package com.zero.sftp.common.config;
...
//        return factory;
    ...
    @Bean
    public SftpRemoteFileTemplate remoteFileTemplate(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
        return new SftpRemoteFileTemplate(sftpSessionFactory);
    }

    @Bean
    @ServiceActivator(inputChannel = "downloadChannel")
    public MessageHandler downloadHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
    ...
    public MessageHandler uploadHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
...
//        handler.setChmod();
    ...
    public MessageHandler multiTypeHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
        SftpMessageHandler handler = new SftpMessageHandler(sftpSessionFactory);
        handler.setRemoteDirectoryExpression(new LiteralExpression(properties.getRemoteDir()));
        handler.setFileNameGenerator(message -> {
    ...
    public MessageHandler lsHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
    ...
    public MessageHandler listFileNamesHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
    ...
    public MessageHandler getFileHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
    ...
    public MessageHandler abcHandler(SessionFactory<SftpClient.DirEntry> sftpSessionFactory) {
        SftpMessageHandler handler = new SftpMessageHandler(sftpSessionFactory);
        handler.setRemoteDirectoryExpression(new LiteralExpression(properties.getRemoteDir()));
        handler.setFileNameGenerator(message -> {
            if (message.getPayload() instanceof byte[]) {
